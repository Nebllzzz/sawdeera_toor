<div class="verification-row">
    ...
    @if($step['note'])<div class="row-note"><i class="fas fa-exclamation-triangle mr-2"></i><b>Catatan Admin:</b> {{ $step['note'] }} @if($url)<a href="{{ $url }}" class="float-right">Perbaiki Sekarang</a>@endif</div>@endif
</div>
